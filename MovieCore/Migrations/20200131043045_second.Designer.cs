...
namespace MovieCore.Migrations
{
    ...
    [Migration("20200131043045_second")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieCore.Models.ContributorLanguage", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("ContributorLanguages");
                });
            ...
            modelBuilder.Entity("MovieCore.Models.ContributorTypeLanguage", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("ContributorTypeLanguages");
                });
            ...
            modelBuilder.Entity("MovieCore.Models.GenreLanguage", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MovieCore.Models.MovieLanguage", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MovieCore.Models.MovieLanguage", b =>
                {
                    b.HasOne("MovieCore.Models.Movie", "Movies")
                        .WithMany()
                        .HasForeignKey("MovieID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
